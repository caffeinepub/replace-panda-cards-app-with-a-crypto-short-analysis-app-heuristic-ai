...
export class Backend implements backendInterface {
    ...
    async getAllCards(): Promise<Array<PandaCard>> {
    ...
    async getBaseGlowEffectIntensity(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getBaseGlowEffectIntensity();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCardById(arg0: bigint): Promise<PandaCard> {
        if (this.processError) {
            try {
    ...
    async getCardCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCardCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCardsByRarity(arg0: string): Promise<Array<PandaCard>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCardsByRarity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRandomCard(): Promise<PandaCard> {
        if (this.processError) {
            try {
                const result = await this.actor.getRandomCard();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
